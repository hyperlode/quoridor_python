...
if __name__ == "__main__":
    ...
    # l = Quoridor_local_game("Lode", "auto_3", ['n', 's', 'n', 's', 'n', 's', '3e', '3b', 'd3', '6e', '6b', 'd6'])
    l = Quoridor_local_game("Lode", "computerDoesNotSeeTrap", ['n', 's', 'n', 's', 'n', 's', '3e', '3b', 'd3', '6e', '6b', 'd6', '4c', 's', 'f4', '5c','4a'])
